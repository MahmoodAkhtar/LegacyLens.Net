...
- detecting Spring.NET and similar XML/configuration-driven wiring evidence from `app.config`, `web.config`, `*.config`, external XML object-definition files, Castle Windsor XML, Unity XML, Enterprise Library/ObjectBuilder-style configuration, and custom object factory sections where feasible
